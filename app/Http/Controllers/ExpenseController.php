...
class ExpenseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'payment_method' => 'nullable|string|in:Omzet Kandang,Tunai Pribadi,Transfer Pribadi,Kas Tunai,Transfer Bank',
        ...
        $expense = Expense::create([
            ...
            'payment_method' => $validated['payment_method'] ?? 'Omzet Kandang',
    ...
    public function show(Request $request, $id)
    {
        try {
            ...
            $data = [
                ...
                'payment_method' => $expense->payment_method ?? 'Omzet Kandang',
                'notes' => $expense->notes ?? '',
